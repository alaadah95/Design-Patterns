...
public class Client {
	...
	public static void main(String[] args) {
		...
		Employee empVp = buildOrganization();
		
		PrintVisitor visitor = new PrintVisitor();
		
		iterate(empVp, visitor);
		
	}
	
	private static void iterate(Employee employee , Visitor visitor) {
		employee.accept(visitor);
		employee.getDirectReports().forEach(e->iterate(e, visitor));
	}
